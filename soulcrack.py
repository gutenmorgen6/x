...
bot = telebot.TeleBot('7554591069:AAFOeUASikncZ3h_1k7y4kZz8YD5cY9cnzI')
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  
            ...
            if time > 181:
                ...
                full_command = f"./soulcrack {king} {soulking} {time}"
        ...
        response = " ミ🥹★ 𝘈𝘤𝘤𝘦𝘴𝘴 𝘭𝘦 𝘭𝘦 𝘣𝘳𝘰 ★🥹彡DM -  https://t.me/+st35bwsxDk83YWJl  ."
